...
namespace WareHouse.PC
{
    ...
    /// </summary>
    public partial class frmFormD : DevExpress.XtraBars.Ribbon.RibbonForm, IDXManagerPopupMenu
    {
        #region Fields
        ...
        public frmFormD(DevExpress.XtraScheduler.SchedulerControl control, Appointment apt)
            : this(control, apt, false)
        {
        }
        public frmFormD(DevExpress.XtraScheduler.SchedulerControl control, Appointment apt, bool openRecurrenceForm)
        {
